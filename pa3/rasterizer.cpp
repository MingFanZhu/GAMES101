        ...
        for(int y = y_min; y <= y_max; ++y)
        {
            if(insideTriangle(x, y, t.v))
            {
                ...
                if(zp < depth_buf[ind])
                {
                    ...
                    if(interpolated_texcoords.x() < 0) interpolated_texcoords.x() = 0;
                    if(interpolated_texcoords.x() > 1) interpolated_texcoords.x() = 1;
                    if(interpolated_texcoords.y() < 0) interpolated_texcoords.y() = 0;
                    if(interpolated_texcoords.y() > 1) interpolated_texcoords.y() = 1;
